            ...
            child : SingleChildScrollView(
                ...
                child: Column(
                    children: [    
                                      ...
                                      children: 
                                        List.generate(6, (index) => Column(
                                          ...
                                          children: [
                                            ...
                                            10.heightBox,
                                            "Wool 4kg".text.fontFamily(semibold).color(darkFontGrey).make(),
                                            10.heightBox,
                                            "Rs. 2000".text.fontFamily(bold).color(redColor).size(16).make(),
                                          ],
                      ...
                      Align(
                        alignment: Alignment.centerLeft,
                        child: Text(allProduct, style: TextStyle(color:Colors.red,fontFamily: semibold, fontSize: 18),
                        )
                      ),
                      GridView.builder(
